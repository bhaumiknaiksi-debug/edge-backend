...
function getNearestExpiry(skipWeeks) {
  ...
  // Only skip same-day expiry AFTER market close (3:30 PM IST = 930 mins)
  // Before close, same-day Thursday IS the active expiry with all liquidity
  ...
  var result = y + "-" + m + "-" + d;
  console.log("Expiry calc: IST day=" + day + " mins=" + mins + " daysToThursday=" + daysToThursday + " expiry=" + result);
  return result;
}
